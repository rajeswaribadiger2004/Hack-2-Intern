...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-app" id="list-app-list" role="tab" data-toggle="list" aria-controls="home">Academics</a>
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home"> Suggestion List</a>
               ...
               <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> View Academics</h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: 15%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Suggestions</h4>
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Academic end Time</th>
                  ...
                  <?php 
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                     ...
                     <td>
                        ...
                        <button class="btn btn-success">Suggest</button></a>
                        <?php } else {
        ...
        <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Sports remakrs</th>
                    <th scope="col">Ovearall analysis</th>
